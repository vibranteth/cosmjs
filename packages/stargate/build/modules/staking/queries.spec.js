    ...
    describe("validatorDelegations", () => {
        it("works", async () => {
            ...
            expect(response.delegationResponses).toContain({
                delegation: {
                    delegatorAddress: testutils_spec_1.validator.delegatorAddress,
                    validatorAddress: testutils_spec_1.validator.validatorAddress,
                    shares: "3000000000000000000000000",
                },
                balance: { denom: "ustake", amount: "3000000" },
            });
            expect((_a = response.pagination) === null || _a === void 0 ? void 0 : _a.total.toNumber()).toBeGreaterThanOrEqual(2);
            tmClient.disconnect();
        });
    });
    describe("validators", () => {
