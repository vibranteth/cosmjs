...
describe("TxExtension", () => {
    ...
    describe("simulate", () => {
        it("works", async () => {
            ...
            expect((_b = response.gasInfo) === null || _b === void 0 ? void 0 : _b.gasUsed.toNumber()).toBeLessThanOrEqual(200000);
            expect((_c = response.gasInfo) === null || _c === void 0 ? void 0 : _c.gasWanted).toEqual(
            // Some dummy value. Value does not matter for regular users.
            (0, testutils_spec_1.simapp44Enabled)() ? long_1.default.UZERO : long_1.default.MAX_UNSIGNED_VALUE);
            tmClient.disconnect();
        });
    });
});
