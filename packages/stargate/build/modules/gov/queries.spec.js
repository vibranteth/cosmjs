        ...
        it("works", async () => {
            ...
            expect(response.votes).toEqual([
                ...
                gov_1.Vote.fromPartial({
                    proposalId: (0, queryclient_1.longify)(proposalId),
                    voter: voter2Address,
                    option: (0, testutils_spec_1.simapp44Enabled)()
                        ? gov_1.VoteOption.VOTE_OPTION_NO_WITH_VETO
                ...
                gov_1.Vote.fromPartial({
                    proposalId: (0, queryclient_1.longify)(proposalId),
                    voter: voter1Address,
                    option: (0, testutils_spec_1.simapp44Enabled)() ? gov_1.VoteOption.VOTE_OPTION_YES : gov_1.VoteOption.VOTE_OPTION_UNSPECIFIED,
                    options: [
                        gov_1.WeightedVoteOption.fromPartial({
                            option: gov_1.VoteOption.VOTE_OPTION_YES,
                            weight: "1000000000000000000",
