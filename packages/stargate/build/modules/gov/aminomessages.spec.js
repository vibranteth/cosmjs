    ...
    describe("toAmino", () => {
        ...
        it("works for MsgVoteWeighted", () => {
            const msg = {
                ...
                voter: "cosmos1xy4yqngt0nlkdcenxymg8tenrghmek4nmqm28k",
                options: [
                    { option: gov_1.VoteOption.VOTE_OPTION_NO_WITH_VETO, weight: "700000000000000000" /* 0.7 */ },
                    { option: gov_1.VoteOption.VOTE_OPTION_NO, weight: "300000000000000000" /* 0.3 */ },
                ],
            };
            const aminoTypes = new aminotypes_1.AminoTypes((0, aminomessages_1.createGovAminoConverters)());
            const aminoMsg = aminoTypes.toAmino({
            ...
            const expected = {
                ...
                value: {
                    ...
                    voter: "cosmos1xy4yqngt0nlkdcenxymg8tenrghmek4nmqm28k",
                    options: [
                        { option: gov_1.VoteOption.VOTE_OPTION_NO_WITH_VETO, weight: "0.700000000000000000" },
                        { option: gov_1.VoteOption.VOTE_OPTION_NO, weight: "0.300000000000000000" },
                    ],
                },
            };
            expect(aminoMsg).toEqual(expected);
    ...
    describe("fromAmino", () => {
        ...
        it("works for MsgVoteWeighted", () => {
            ...
            const expectedValue = {
                ...
                voter: "cosmos1xy4yqngt0nlkdcenxymg8tenrghmek4nmqm28k",
                options: [
                    { option: gov_1.VoteOption.VOTE_OPTION_NO_WITH_VETO, weight: "750000000000000000" },
                    { option: gov_1.VoteOption.VOTE_OPTION_NO, weight: "250000000000000000" },
                ],
            };
            expect(msg).toEqual({
                typeUrl: "/cosmos.gov.v1beta1.MsgVoteWeighted",
