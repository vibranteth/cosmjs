...
class SigningStargateClient extends stargateclient_1.StargateClient {
    constructor(tmClient, signer, options) {
        ...
        this.signAminoJsonTxEnabled = (_b = options.signAminoJsonTxEnabled) !== null && _b !== void 0 ? _b : false;
    }
    ...
    async signAndBroadcast(signerAddress, messages, fee, memo = "") {
        ...
        const txEncoded = tx_3.TxRaw.encode(tx).finish();
    ...
    async signAmino2(signerAddress, messages, fee, memo, { accountNumber, sequence, chainId }) {
        ...
        const gasLimit = math_1.Uint53.fromString(signed.fee.gas).toNumber();
        const signedAuthInfoBytes = (0, proto_signing_1.makeAuthInfoBytes)([{ pubkey, sequence }], fee.amount, gasLimit, fee.granter, fee.payer, signMode);
    ...
    async signAmino(signerAddress, messages, fee, memo, { accountNumber, sequence, chainId }) {
        ...
        if (this.signAminoJsonTxEnabled) {
            const signedGasLimit = math_1.Uint64.fromString(signed.fee.gas).toNumber();
            const signedSequence = math_1.Uint64.fromString(signed.sequence).toNumber();
            ...
            return tx_3.TxRaw.fromPartial({
                bodyBytes: (0, amino_1.serializeSignDoc)(signed),
                authInfoBytes: signedAuthInfoBytes,
                signatures: [(0, encoding_1.fromBase64)(signature.signature)],
            });
        }
