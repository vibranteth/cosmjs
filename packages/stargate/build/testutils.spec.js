...
class ModifyingDirectSecp256k1HdWallet extends proto_signing_1.DirectSecp256k1HdWallet {
    ...
    async signDirect(address, signDoc) {
        ...
        const modifiedSignDoc = {
            ...
            authInfoBytes: (0, proto_signing_1.makeAuthInfoBytes)(signers, modifiedFeeAmount, modifiedGasLimit, modifiedFeeGranter, modifiedFeePayer, signing_1.SignMode.SIGN_MODE_DIRECT),
        };
